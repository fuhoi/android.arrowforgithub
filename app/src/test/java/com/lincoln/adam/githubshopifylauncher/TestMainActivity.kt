...
import com.lincoln.adam.githubshopifylauncher.presentation.*
...
class TestInfoModule: InfoModule() {
    ...
    override fun providesInfoFormat1(): Info = Info("Hello World! ${TestMainActivity.id++}")

    override fun providesInfoFormat2(): Info = Info("${TestMainActivity.id++} Hello World!")
