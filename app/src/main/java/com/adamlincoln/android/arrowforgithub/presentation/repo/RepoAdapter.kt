...
class RepoAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(LayoutInflater.from(context).inflate(R.layout.fragment_repo_item, parent, false))
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        setTextAndVisibility(holder.stargazersCount, viewModel.stargazers_text)
        setTextAndVisibility(holder.forkText, viewModel.fork_text)
        setTextAndVisibility(holder.timeSinceCreated, viewModel.time_since_created_text)
        setTextAndVisibility(holder.forkCount, viewModel.fork_text)
